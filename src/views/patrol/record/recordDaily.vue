<template>
  <div class="user-box">
    ...
    <div class="ipt-btn-box" >
      ...
      <el-date-picker class="sleq w150" type="date" v-model="getpatrolTimes" placeholder="起始时间"></el-date-picker>至<el-date-picker @change="handleIconClick" v-model="overpatrolTimes" class="slez w150" type="date" placeholder="截止时间"></el-date-picker>
    ...
    <div :class="down?'tabOffTop170':'tabOffTop120'">
      <el-table :data="tableData" class="table-div" :class="shadowShow?'shadowNo':''" @sort-change="handleSortChange" :key="maxheight" :max-height="maxheight">
        ...
        <el-table-column show-overflow-tooltip prop="deptName"
        ...
        <el-table-column show-overflow-tooltip prop="superviseName"
                         label="监管人员"></el-table-column>
        <el-table-column show-overflow-tooltip prop="messName"
                         label="信息员"></el-table-column>
        <el-table-column show-overflow-tooltip prop="result"
  ...
  export default {
    ...
    methods: {
      ...
      async getPage() {
        ...
        if (this.getpatrolTimes != null && this.overpatrolTimes != null) {
          this.search.startDate = this.getpatrolTimes;
          this.search.endDate = this.overpatrolTimes;
        }
        var formData = {
          params: this.search,
          num: this.page.num,
