...
import { dailyEntityPage,getDailyContext,dailyRecordAdd,getBasicInfo }  from 'api/patrol/dailyRecordAdd.js';
...
export default {
    ...
    methods:{
          ...
          if (valid){
            this.$confirm('是否要提交巡查记录?', '提示', {
              ...
              type: 'warning'
                ...
                score = score + "";
                obj.record = { entityId,patrolTime,score,result,treat,treatRemark,rectifyTime,isCooperate,patrolSoId,infoList,patrolPlanType  };
        ...
        slmainbody(obj){
            ...
            //获取巡查项
            getDailyContext({type:'SYS',entityType:obj.entityType})
                .then(res=>{
                    const data = res.data;
