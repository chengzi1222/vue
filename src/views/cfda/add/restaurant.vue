          ...
          <div class="content">
            ...
            <div class="row">
              <el-form-item label="工商证照期限:" prop="licLimit">
                <el-date-picker class="w200" v-model="cfda.licLimit" type="date" placeholder="选择工商证照期限" :editable="false" :picker-options="beginCurrDate">
                </el-date-picker>
              </el-form-item>
          ...
          <div class="content">
            ...
            <div class="row">
              <el-form-item label="风险等级:" prop="riskRank">
                <el-select clearable @clear="blurCount" v-model="cfda.riskRank" placeholder="请选择">
              ...
              <el-form-item label="量化等级:" @clear="blurCount" prop="quanLevel">
                <el-select clearable v-model="cfda.quanLevel" placeholder="请选择">
            ...
            <!-- <div class="row">
              <el-form-item label="详细经营信息:" >
                <el-checkbox-group v-model="cfda.detailedEngage" size="large">
                  <el-checkbox-button v-for="item in detailedEngageItem" :label="item.code" :key="item.id">{{item.name}}</el-checkbox-button>
                </el-checkbox-group>
              </el-form-item>
            </div>-->
            <div class="row">
...
//        licStateSelect: [],
        ...
        rules: {
          ...
          licLimit: [
            { required: true, message: '请选择工商证照期限', trigger: 'blur' },
            { validator: this.blurCount, trigger: 'blur' }
          ],
          recordNum: [
