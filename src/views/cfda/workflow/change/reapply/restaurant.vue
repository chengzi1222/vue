          ...
          <div class="content">
            <div class="row">
              ...
              <el-form-item label="社会信用代码:" prop="creditCode">
                <el-input class="w200" :maxlength="255" v-model="cfda.creditCode" placeholder="请输入社会信用代码"></el-input>
              </el-form-item>
            </div>
...
import { addCfda, addAutoSave, getSyj, getGrid, getSoEmp, getInfoAssi, getAutoSave, getBackup, removeFile, getEntityByCredit} from "api/cfda/add.js";
...
export default {
  async mounted() {
    ...
    /*if (this.$route.params.cid){
      ...
      this.cid = '600f5b98adb711e7bcb43cbf104428a9';
    }*/
