        ...
        <div class="main_content">
            ...
            <section class="item1 clearfix">
                <div class="floatL">
                    <p>溯源纳入情况</p>
                    <div class="textC">
                        <p><span style="color:#393939;font-size:36px;" >{{ sourceNunber }}</span><span style="font-size:36px;">/40</span>家</p>
                        <p>批发市场数量</p>
                    </div>
                </div>
                <div class="floatR">
...
<script>
import pie_echart from "./echarts/pie_echart";
import bar_echart from "./echarts/bar_echart";
import bar2_echart from "./echarts/bar2_echart";
import barline_echart from "./echarts/bar_line_echart";
