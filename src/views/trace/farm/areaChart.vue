<template>
    <div class="area">
        <div class="page-tilt">
            <b></b><span>农贸市场溯源监管{{ title == '' ? '': '-'+title }}</span><Back v-show="backshow"></Back>
        </div>
      ...
      if (this.seldate == null) {
        ...
        api
          ...
          .then(d => {
            ...
            bar_echart(this.useData, "FAusearea");
          });
      }
    },
    dc() {
    ...
    dc_areas() {
      api
        ...
        .then(d => {
          ...
          bar_echart(this.bar1Data, "FAbar1", this);
        });
    },
    dc_rate_low() {
      api
    ...
    dc_rate() {
      ...
      api
        ...
        .then(d => {
          ...
          bar_echart(this.useData, "FAusearea", this);
        });
    },
    dc_his() {
      api
        ...
        .then(d => {
          ...
          bar_echart(this.hisData, "FAhis", this);
        });
    },
    get() {
      //溯源纳入情况总数
